                            ...
                            <div className="render_circle">
                                {
                                    window.screen.width > 500 ? (
                                        ...
                                        <CircularComponent size={window.screen.width * 0.35} thick={7} value={60} color="rgba(105, 157, 255, 1)" text="700 kcal" />
                                    )
                                }
                            </div>
                        </div>
                            ...
                            <div className="render_circle">
                                {
                                    window.screen.width > 500 ? (
                                        ...
                                        <CircularComponent size={window.screen.width * 0.35} thick={7} value={35} text="70g" color="rgba(167, 212, 137, 1)" />
                                    )
                                }
                            </div>
                        </div>
